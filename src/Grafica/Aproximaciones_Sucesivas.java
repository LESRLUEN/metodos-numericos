...
import Projectofinal.Aproximaciones_sucesivas;
...
public class Aproximaciones_Sucesivas {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Aproximaciones_Sucesivas window = new Aproximaciones_Sucesivas();
		...
		EncontrarSolucion.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
                ...
                try {
					...
					Aproximaciones_sucesivas B = new Aproximaciones_sucesivas(F,X1,Lim,E);
